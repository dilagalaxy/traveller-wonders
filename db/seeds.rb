...
Product.create(:name => "MSR HUBBA HUBBA NX 2-PERSON TENT", :description => " Head and elbow room throughout tent; two large side-entry vestibules to store gear Two large StayDry doors with built-in rain gutters; adaptable, cross-ventilating rainfly Unified hub-and-pole system with color-coded clips; ultra-compact compression stuff sack.
", :image_url => "https://static1.squarespace.com/static/5346a846e4b0101b157468cf/5554fe12e4b077499cda64a6/55550063e4b0f031496a1aa2/1431634385873/Hubba+Hubba.jpg ", :colour => "Red ", :price => "$346.00 ")